...
# 1. Update app/robo-pose.tsx to listen to GAME_EXIT and remove floating absolute buttons that cover the iframe
rn_path = r"d:\project-26\RoboMind\app\robo-pose.tsx"

rn_code = """import React, { useState, useEffect, useRef } from "react";
import {
  StyleSheet,
  View,
  Text,
